            ...
            <div id="questions-container">
                <?php if (!empty($questions)) : ?>
                    <?php foreach ($questions as $index => $question) : ?>
                        <div class="question-box" data-question-type="<?= htmlspecialchars($question->question_type, ENT_QUOTES, 'UTF-8') ?>" data-question_id="<?= htmlspecialchars($question->question_id, ENT_QUOTES, 'UTF-8') ?>" >
...
<div id="question-template" style="display: none;">
    <div class="question-box" data-question-type="multiple-choice">
        <div class="question-box_header">
            <input type="text" class="question-box_header_question" style="color: black;" placeholder="Question">
            <img style="display:none;" src="<?= base_url() ?>assets/images/image.png" alt="add an image" height="20px" width="20px">
            <div class="question-box_header_question-type">
                <select class="question-box_header_question-type_select">
        ...
        <div class="options-container">
            <div class="question-box_option-block">
                <img class="question-type-image" src="<?= base_url() ?>assets/images/circle.png" alt="option multiple-choice" width="16px" height="16px">
                <input type="text" class="question-box_option-block_option-text" placeholder="Option 1">
            </div>
            <div id="new-options"></div>
            <div class="question-box_add-option">
                <button class="add-option" style="color:#1a73e8;font-weight: 500;">Add Option</button>
